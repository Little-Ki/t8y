...
namespace t8::core {
    ...
    bool emu_init(AppContext *ctx) {
        ...
        gfx_palc(mem, 0, _RGBA(0, 0, 0, 255));
        gfx_palc(mem, 1, _RGBA(250, 250, 250, 255));
        gfx_palc(mem, 2, _RGBA(190, 190, 190, 255));
        gfx_palc(mem, 3, _RGBA(200, 60, 90, 255));
        gfx_palc(mem, 4, _RGBA(240, 130, 90, 255));
        gfx_palc(mem, 5, _RGBA(250, 200, 120, 255));
        gfx_palc(mem, 6, _RGBA(60, 180, 100, 255));
        gfx_palc(mem, 7, _RGBA(40, 110, 120, 255));
        gfx_palc(mem, 8, _RGBA(40, 70, 150, 255));
        gfx_palc(mem, 9, _RGBA(150, 60, 150, 255));
        gfx_palc(mem, 10, _RGBA(250, 120, 170, 255));
        gfx_palc(mem, 11, _RGBA(250, 200, 170, 255));
        gfx_palc(mem, 12, _RGBA(130, 140, 160, 255));
        gfx_palc(mem, 13, _RGBA(150, 180, 190, 255));
        gfx_palc(mem, 14, _RGBA(90, 110, 130, 255));
        gfx_palc(mem, 15, _RGBA(50, 60, 90, 255));
        ...
        while (true) {
            ...
            for (auto y = 0; y < 128; y++) {
                for (auto x = 0; x < 128; x++) {
                    auto n = gfx_pget(ctx->memory, x, y);
                    n = gfx_pal(ctx->memory, n);
