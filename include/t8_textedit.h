...
namespace t8 {
    ...
    private:
        ...
        SizedStack<UndoRecord, 64> _redos;
    ...
    private:
        ...
        Lines parse(const std::string &text);

        void erase(const Coord &from, const Coord &to);

        template <typename T>
        void erase(std::vector<T> &vec, int a, int b) {
